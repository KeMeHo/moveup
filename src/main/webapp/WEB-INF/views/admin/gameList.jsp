                            ...
                            <div class="x_content">
                                ...
                                <div class=" col-sm-1 col-sm-1 col-xs-12">
                                    <a class="btn btn-round btn-success"
                                       href="${pageContext.request.contextPath}/admin/game/regist/"
                                ...
                                <div class="table-responsive">
                                    <table id="gameListTable" class="table table-striped jambo_table bulk_action">
                                        <thead>
                                        <tr class="headings">
...
<div class="modal fade delete-game-modal" tabindex="-1" role="dialog" aria-hidden="true">
...
<script>
    ...
    var datatable = $('#gameListTable').DataTable({
        dom:'lrtip',
        processing: true,
        serverSide: true,
        ajax: {
        ...
        columns: [
            {
                ...
                render: function (data, type, full, meta) {
                    ...
                    if(full.type==3){
                        return '<button type="button" class="btn btn-success" style="width: 80px;">GAME</button>';
                    }
                    if(full.type==0){
    ...
    function gotoUpdate(id) {
        $('#gameLoading').show();
        window.location.href = '${pageContext.request.contextPath}/admin/game/edit/' + id + '/';
    }
    ...
    function gotoRegist() {
        $('#gameLoading').show();
        window.location.href =  '${pageContext.request.contextPath}/admin/game/regist/';
    }
    ...
    function confirmDeleteClick() {
        ...
        $('#gameLoading').show();
        var form = $("<form></form>");
        form.attr('action', '${pageContext.request.contextPath}/admin/game/delete/');
        form.attr('method', 'post');
        var input1 = $("<input type='hidden' name='id'/>");
        input1.attr('value', currDeleteGameId);
        form.append(input1);
        form.appendTo("body");
