                    ...
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        <div class="x_panel">
                            ...
                            <div class="x_content">
                                ...
                                <form:form id="userForm" modelAttribute="gameForm"  enctype="multipart/form-data"
                                           action="${pageContext.request.contextPath}/admin/game/update/"
                                    ...
                                    <div>
                                        ...
                                        <div class="col-md-1 col-sm-6 col-xs-12">
                                            <form:select path="type" required="required" data-validate-minmax="10,100"
                                                ...
                                                <c:if test="${gameForm.type ==1}">
                                                    <form:option value="1">EVENT</form:option>
                                                    <form:option value="2">MOVEUP</form:option>
                                                    <form:option value="3">GAME</form:option>
                                                </c:if>
                                                <c:if test="${gameForm.type ==2}">
                                                    <form:option value="1">EVENT</form:option>
                                                    <form:option value="2">MOVEUP</form:option>
                                                    <form:option value="3">GAME</form:option>
                                                </c:if>
                                                <c:if test="${gameForm.type ==3}">
                                                    <form:option value="1">EVENT</form:option>
                                                    <form:option value="2">MOVEUP</form:option>
                                                    <form:option value="3">GAME</form:option>
                                                </c:if>
                                ...
                                <div class="item form-group">
                                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="">ゲーム詳細抜粋 <span
                                            class="required">*</span>
                                    </label>
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <form:input path="excerpt" type="text" id="excerpt" name="excerpt" required="required"
                                                    class="form-control col-md-7 col-xs-12"
                                                    value="${gameForm.excerpt}"/>
                                    </div>
                                </div>
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12"  >
                                        ...
                                        <div class="col-md-12 col-sm-12 col-xs-12">
                                            ...
                                            <%--<c:forEach items="${gameForm.picUrl1}" var="url1">--%>
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12"  >
                                        ...
                                        <div class="col-md-12 col-sm-12 col-xs-12">
                                            <form:input path="picFile2" id="picFile2"
                                                        ...
                                                        required="" type="file" multiple="multiple"/>
                                            <%--<c:forEach items="${gameForm.picUrl2}" var="url1">--%>
                                                <%--<div><img src="${url1}" class='file-preview-image kv-preview-data  col-md-2 col-sm-1 col-xs-12'--%>
                                                          <%--style='width:20%;height:20%;max-width:100%;max-height:100%;margin-bottom: 20px;' alt='' title=''></div>--%>
                                            <%--</c:forEach>--%>
                                        </div>
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <form:input path="detail" id="detail"  required="" name="detail" type="hidden"
                                                     ...
                                                     value="${gameForm.detail}"></form:input>
                                        <div class="x_content">
                                            <div id="alerts"></div>
                            ...
                            <div class="form-group">
                                <div class="col-md-6 col-md-offset-3">
                                    <a class="btn btn-primary" href="/admin/game/list/" style="width: 100px;">キャンセル</a>
                                    <form:input type="hidden" path="id" value="${gameForm.id}"/>
                                    <form:input type="hidden" path="picUrl1" value="${gameForm.picUrl1}"/>
                                    <form:input type="hidden" path="picUrl2" value="${gameForm.picUrl2}"/>
...
<div id="gameLoading" style="display: none" class="loading">
...
<script>
    ...
    $('#picFile1').fileinput({
        ...
        <c:if test="${gameForm.picUrl1 != null && gameForm.picUrl1 != ''}">
    ...
    $('#picFile2').fileinput({
        'language':'ja', 'showClose': true, 'showCaption':false,'showRemove':false,'dropZoneTitle':'', 'showUpload': false, 'previewFileType': 'any', 'autoReplace': true,"minImageWidth":500,"maxImageWidth":500,"minImageHeight":500,"maxImageHeight":500
        <c:if test="${gameForm.picUrl2 != null && gameForm.picUrl2 != ''}">
        , 'uploadUrl': null, 'initialPreview': [
            <c:forEach items="${gameForm.picUrl2}" var="url2">
